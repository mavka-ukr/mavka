...
extern п64 __піднести_до_степеня_п64(п64 значення, п64 степінь) {
  п64 результат = 1;
...
extern ц64 __піднести_до_степеня_ц64(ц64 значення, ц64 степінь) {
  ц64 результат = 1;
...
extern double __піднести_до_степеня_д64(double значення, double степінь) {
