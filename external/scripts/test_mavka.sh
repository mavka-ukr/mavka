...
TESTS=(
  ...
  "тести/юнікод/1_юнікод_отримання_елементів.м" \
  "тести/юнікод/2_юнікод_перевірка_на_місткість_елементів.м" \
  "тести/юнікод/3_юнікод_перебір.м" \
  "тести/юнікод/4_юнікод_додавання.м" \
