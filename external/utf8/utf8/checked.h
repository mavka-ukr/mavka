...
namespace utf8 {
  ...
  inline output_iterator replace_invalid(octet_iterator start,
                                         octet_iterator end,
                                         output_iterator out) {
    static const utfchar32_t replacement_marker =
        utf8::internal::mask16(0xfffd);
  ...
  u16bit_iterator utf8to16(octet_iterator start,
    ...
    while (start < end) {
      ...
      if (cp > 0xffff) { // make a surrogate pair
        *result++ =
            static_cast<utfchar16_t>((cp >> 10) + internal::LEAD_OFFSET);
        *result++ = static_cast<utfchar16_t>((cp & 0x3ff) +
