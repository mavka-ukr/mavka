...
extern void пристрій_мавки_вивести_колір(природне значення) {
  HANDLE консоль = GetStdHandle(STD_OUTPUT_HANDLE);
...
extern void пристрій_мавки_вивести_кд(природне колір,
                                      природне розмір,
                                      п8* дані) {
  природне розмір_ю8;
  п8* дані_ю8;
...
extern адреса пристрій_мавки_виділити_сиру_памʼять(природне розмір) {
  ...
  return (адреса)HeapAlloc(купа, 0, розмір);
}
...
extern адреса пристрій_мавки_перевиділити_сиру_памʼять(адреса значення,
  ...
  HANDLE купа = GetProcessHeap();
  if (значення == NULL) {
    return (адреса)HeapAlloc(купа, 0, новий_розмір);
  }
  return (адреса)HeapReAlloc(купа, 0, значення, новий_розмір);
}
...
логічне перетворити_р64_в_ю8(р64 значення,
                             природне* вихід_розміру,
                             п8** вихід_даних,
...
extern логічне пристрій_мавки_перетворити_р64_в_кд(
    р64 значення,
    природне* вихід_розміру,
    п8** вихід_даних,
    ціле* вихід_розміру_експоненти) {
  ...
  if (перетворити_р64_в_ю8(значення, &розмір_ю8, &дані_ю8,
...
extern логічне пристрій_мавки_читати_кд(природне розмір_перед,
                                        ...
                                        природне дозволити_історію,
                                        природне* кінець_файлу) {
  пристрій_мавки_вивести_кд(КолірВиводуСтандартний, розмір_перед, дані_перед);
