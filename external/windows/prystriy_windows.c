...
логічне (*користувацький_пристрій_мавки_читати_ю8)(природне розмір_перед,
                                                   п8* дані_перед,
...
void out_utf8_data(п8* дані, природне розмір) {
  ...
  WCHAR* широкий_буфер = (WCHAR*)пристрій_мавки_виділити_сиру_памʼять(
      широких_символів * sizeof(WCHAR));
  if (!широкий_буфер) {
    return;
  }
  ...
  пристрій_мавки_звільнити_сиру_памʼять(широкий_буфер);
}
...
extern логічне пристрій_мавки_прочитати_файл(природне розмір_шляху,
  ...
  пристрій_мавки_звільнити_сиру_памʼять(широкий_шлях);
  ...
  *вихід_даних = (п8*)пристрій_мавки_виділити_сиру_памʼять(*вихід_розміру);
  ...
  if (!ReadFile(файл, *вихід_даних, *вихід_розміру, &прочитано, NULL)) {
    пристрій_мавки_звільнити_сиру_памʼять(*вихід_даних);
    CloseHandle(файл);
    return FALSE;
  }
...
extern логічне пристрій_мавки_отримати_абсолютний_шлях(природне розмір_шляху,
  ...
  WCHAR* абсолютний_широкий =
      (WCHAR*)пристрій_мавки_виділити_сиру_памʼять(потрібно * sizeof(WCHAR));
  ...
  if (GetFullPathNameW(широкий_шлях, потрібно, абсолютний_широкий, NULL) == 0) {
    пристрій_мавки_звільнити_сиру_памʼять(абсолютний_широкий);
    пристрій_мавки_звільнити_сиру_памʼять(широкий_шлях);
    return FALSE;
  }
...
extern логічне пристрій_мавки_отримати_назву_модуля_з_шляху_ю8(
  ...
  п8* назва_ю8 = (п8*)пристрій_мавки_виділити_сиру_памʼять(довжина_назви);
  if (!назва_ю8) {
    return FALSE;
  }
...
extern логічне пристрій_мавки_отримати_відносний_шлях(природне розмір_шляху,
  ...
  WCHAR* поточна_тека = (WCHAR*)пристрій_мавки_виділити_сиру_памʼять(
      розмір_поточної * sizeof(WCHAR));
  if (!поточна_тека) {
    пристрій_мавки_звільнити_сиру_памʼять(широкий_шлях);
    return FALSE;
  }
...
char* read_line_no_newline(size_t* out_len) {
  ...
  size_t wide_len = 0;
  WCHAR* wide_buf =
      (WCHAR*)пристрій_мавки_виділити_сиру_памʼять(wide_cap * sizeof(WCHAR));
  if (!wide_buf)
    return NULL;
  ...
  while (ReadConsoleW(hStdin, &wc, 1, &charsRead, NULL) && charsRead == 1) {
    ...
    if (wide_len + 1 >= wide_cap) {
      wide_cap *= 2;
      WCHAR* tmp = (WCHAR*)пристрій_мавки_перевиділити_сиру_памʼять(
          wide_buf, wide_cap * sizeof(WCHAR));
      if (!tmp) {
        пристрій_мавки_звільнити_сиру_памʼять(wide_buf);
        return NULL;
      }
      wide_buf = tmp;
    }
  ...
  char* buf = (char*)пристрій_мавки_виділити_сиру_памʼять(utf8_size + 1);
  if (!buf) {
    пристрій_мавки_звільнити_сиру_памʼять(wide_buf);
    return NULL;
  }
...
extern логічне пристрій_мавки_читати_ю8(природне розмір_перед,
                                        п8* дані_перед,
                                        природне* вихід_розміру,
                                        п8** вихід_даних,
                                        природне дозволити_історію,
                                        природне* кінець_файлу) {
  пристрій_мавки_вивести_ю8(КолірВиводуСтандартний, розмір_перед, дані_перед);
...
extern логічне пристрій_мавки_отримати_поточний_шлях_процесу(
  ...
  WCHAR* широкий_шлях =
      (WCHAR*)пристрій_мавки_виділити_сиру_памʼять(розмір * sizeof(WCHAR));
  if (!широкий_шлях) {
    return FALSE;
  }
