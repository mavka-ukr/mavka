...
ціль будування/"$TSIL_ARCH-$TSIL_SYSTEM"/напівготове/бібліотека/бібліотека.ц.ллвмір --архітектура="$TSIL_ARCH" --система="$TSIL_SYSTEM" перетворити бібліотека/бібліотека.ц
...
clang -ggdb --target="$TARGET_TRIPLE" -lm -o будування/"$TSIL_ARCH-$TSIL_SYSTEM"/готове/мавка пристрій/prystriy.c start.c \
  -x ir будування/"$TSIL_ARCH-$TSIL_SYSTEM"/напівготове/бібліотека/бібліотека.ц.ллвмір \
