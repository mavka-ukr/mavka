...
- додано змінювати логіку створення структури через `виконати_створення`
- додано гак після створення структури через `виконати_після_створнення`
...
- випаврлено https://github.com/mavka-ukr/mavka/issues/26
