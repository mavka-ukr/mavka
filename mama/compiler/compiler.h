...
MaCompilationResult compile_diia_node(MaMa* M, mavka::ast::DiiaNode* diia_node);
MaCompilationResult compile_each_node(MaMa* M, mavka::ast::EachNode* each_node);
MaCompilationResult compile_eval_node(MaMa* M, mavka::ast::EvalNode* eval_node);
...
MaCompilationResult compile_give_node(MaMa* M, mavka::ast::GiveNode* give_node);
...
MaCompilationResult compile_if_node(MaMa* M, const mavka::ast::IfNode* if_node);
...
MaCompilationResult compile_test_node(MaMa* M, mavka::ast::TestNode* test_node);
...
MaCompilationResult compile_wait_node(MaMa* M, mavka::ast::WaitNode* wait_node);
