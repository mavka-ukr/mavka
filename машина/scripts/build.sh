...
prepare_directories() {
  ...
  mkdir -p "$SEMIREADY_DIR"/предмети/ДіапазонЦілих/методи
  mkdir -p "$SEMIREADY_DIR"/предмети/Дія/методи
  mkdir -p "$SEMIREADY_DIR"/предмети/Дробове/дії
  mkdir -p "$SEMIREADY_DIR"/предмети/Дробове/методи
  ...
  mkdir -p "$SEMIREADY_DIR"/предмети/ПеребірДіапазонуДробових/методи
  mkdir -p "$SEMIREADY_DIR"/предмети/ПеребірДіапазонуЦілих/методи
  ...
  mkdir -p "$SEMIREADY_DIR"/предмети/Ціле/дії
  mkdir -p "$SEMIREADY_DIR"/предмети/Ціле/методи
...
compile_all_tsil_files() {
  ...
  compile_tsil "предмети/ДіапазонДробових/методи/чародія_перебір.ц"
  compile_tsil "предмети/ДіапазонДробових/ПредметДіапазонуДробових.ц"

  compile_tsil "предмети/ДіапазонЦілих/методи/чародія_перебір.ц"
  compile_tsil "предмети/ДіапазонЦілих/ПредметДіапазонуЦілих.ц"

  compile_tsil "предмети/Дія/ПредметДії.ц"

  compile_tsil "предмети/Дробове/методи/чародія_дробове.ц"
  compile_tsil "предмети/Дробове/методи/чародія_текст.ц"
  compile_tsil "предмети/Дробове/методи/чародія_ціле.ц"
  compile_tsil "предмети/Дробове/ПредметДробового.ц"
  ...
  compile_tsil "предмети/ПеребірДіапазонуДробових/методи/далі.ц"
  compile_tsil "предмети/ПеребірДіапазонуДробових/ПредметПереборуДіапазонуДробових.ц"

  compile_tsil "предмети/ПеребірДіапазонуЦілих/методи/далі.ц"
  compile_tsil "предмети/ПеребірДіапазонуЦілих/ПредметПереборуДіапазонуЦілих.ц"
  ...
  compile_tsil "предмети/Текст/методи/чародія_ціле.ц"
  compile_tsil "предмети/Текст/методи/чародія_дробове.ц"
  ...
  compile_tsil "предмети/Ціле/дії/з.ц"
  compile_tsil "предмети/Ціле/методи/чародія_ціле.ц"
  compile_tsil "предмети/Ціле/методи/чародія_дробове.ц"
  compile_tsil "предмети/Ціле/методи/чародія_текст.ц"
  compile_tsil "предмети/Ціле/ПредметЦілого.ц"
