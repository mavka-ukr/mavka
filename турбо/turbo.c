...
typedef void (*ТурбоВідкликНаДоступністьЧитання)(
    ТурбоРушій *рушій, ц32 ідентифікатор, невідома_адреса аргумент_відклику);
typedef void (*ТурбоВідкликНаДоступністьЗапису)(
    ТурбоРушій *рушій, ц32 ідентифікатор, невідома_адреса аргумент_відклику);
typedef void (*ТурбоВідкликПісляВидалення)(ТурбоРушій *рушій, ц32 ідентифікатор,
                                           невідома_адреса аргумент_відклику);
typedef void (*ТурбоВідкликНаРезультатЗапису)(
    ТурбоРушій *рушій, ц32 ідентифікатор, невідома_адреса аргумент_відклику,
    позитивне розмір, памʼять_п8 дані, позитивне розмір_записаного,
    логічне успіх, ТурбоПомилка помилка);
...
логічне турбо_створити_слухач(
    ТурбоРушій *рушій, ц32 ідентифікатор, п32 події,
    ТурбоВідкликНаДоступністьЧитання відклик_на_доступність_читання,
    ТурбоВідкликНаДоступністьЗапису відклик_на_доступність_запису,
    ТурбоВідкликПісляВидалення відклик_після_видалення, void *аргумент_відклику,
...
логічне турбо_видалити_слухач(ТурбоРушій *рушій, ц32 ідентифікатор,
                              ТурбоПомилка *вихід_помилки) {
...
логічне турбо_закрити_слухач(ТурбоРушій *рушій, ц32 ідентифікатор,
                             ТурбоПомилка *вихід_помилки) {
  ТурбоСлухач *слухач = турбо_знайти_слухач(рушій, ідентифікатор);
  if (слухач == NULL) {
    вихід_помилки->код = 0;
...
логічне турбо_прочитати(ТурбоРушій *рушій, ц32 ідентифікатор, позитивне розмір,
                        памʼять_п8 дані, позитивне *вихід_розміру_прочитаного,
...
логічне турбо_додати_запис_в_чергу(
    ТурбоРушій *рушій, ТурбоСлухач *слухач, памʼять_п8 дані, позитивне розмір,
    позитивне розмір_записаного,
    ТурбоВідкликНаРезультатЗапису відклик_на_результат,
    невідома_адреса аргумент_відклику, ТурбоПомилка *вихід_помилки) {
...
void турбо_записати(ТурбоРушій *рушій, ц32 ідентифікатор, позитивне розмір,
                    памʼять_п8 дані,
                    ТурбоВідкликНаРезультатЗапису відклик_на_результат,
                    невідома_адреса аргумент_відклику) {
  ТурбоПомилка турбо_помилка = {0};
...
логічне турбо_прийняти_інтернет_клієнта(
    ц32 ідентифікатор_інтернет_обслуговувача, логічне *вихід_спробувати_пізніше,
...
void турбо_звільнити_сиру_памʼять(невідома_памʼять значення) { free(значення); }
