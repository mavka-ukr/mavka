...
логічне турбо_оновити_події_слухача(ТурбоРушій *рушій, ц32 ідентифікатор,
                                    п32 події, ТурбоПомилка *вихід_помилки) {
...
логічне турбо_додати_запис_в_чергу(
    ТурбоРушій *рушій, ц32 ідентифікатор, памʼять_п8 дані, позитивне розмір,
    позитивне розмір_записаного,
    ТурбоВідкликНаРезультатЗапису відклик_на_результат,
