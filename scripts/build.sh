...
compile_tsil() {
  ...
  $TSIL \
    ...
    перетворити \
    "$(realpath --relative-to="$(pwd)" "$input_file")" -О=./КД/означення -О=./бібліотека/означення -О=./означення
...
compile_all_tsil_files() {
  ...
  compile_tsil "машина/предмети/ПредметПереборуДаних.ц"
  ...
  compile_tsil "машина/предмети/ПредметПереборуПослідовності.ц"
  compile_tsil "машина/предмети/ПредметПереборуСловника.ц"
